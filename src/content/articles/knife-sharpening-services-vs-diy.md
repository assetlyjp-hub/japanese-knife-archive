---
title: "Knife Sharpening Services vs DIY: When to Send Out Your Japanese Knives"
description: "Should you sharpen your Japanese knives yourself or send them to a professional service? An honest comparison of mail-in, in-store, and mobile sharpeners, the bad-grinder warning that ruins blades, recommended providers, prices, and the math on a $300 stone setup."
category: "guide"
tags: ["sharpening", "maintenance", "services", "diy", "whetstone", "tips"]
...
- Total control over edge angle, geometry, and finish.
- The cost amortizes fast if you have multiple knives.
- You can sharpen on demand instead of waiting two to four weeks for a mail-in service.
- The skill transfers — once you can sharpen a gyuto, you can sharpen a Western chef's knife, a pocket knife, scissors, and chisels.
- You actually understand what is happening to the edge, which makes you a better cook and better at protecting the knife.

**Cons:**

- The learning curve is real. Expect twenty to forty hours of practice before you are reliably making knives sharper instead of duller.
- Initial gear cost is $150-400 depending on stone quality.
...
## Recommended Mail-In and In-Store Services
...
|---------|------|----------|-------|
| Korin | In-store + mail-in | New York City | Long-established Japanese knife specialist. Their sharpening team is trained on Japanese knives specifically. |
| Bernal Cutlery | In-store + mail-in | San Francisco | Famous for the depth of their sharpening knowledge. They publish detailed sharpening content. |
| Knife Aid | Mail-in | US-wide | Quality mail-in service with photo documentation. Reasonable lead times. |
| Knife Wear | In-store + mail-in | Canada (multiple cities) | Specialist Japanese knife retailer with in-house sharpening. |
| Town Cutler | In-store + mail-in | Reno / Bay Area | Knife shop with proper Japanese whetstone sharpening. |
| Hida Tool | In-store + mail-in | Berkeley, CA | Japanese tool importer with dedicated sharpening services. |
| Tosho Knife Arts | In-store | Toronto | Highly regarded Japanese knife specialist. |
...
- Belt grinder visible on the workspace.
- "We sharpen everything the same way."
- Pricing under $15 for a 240mm gyuto.
- Cannot or will not name the stones they use.
- Treats Japanese knives as if they were Western (same angle, symmetric grind).
- Offers "free sharpening with purchase" at a hardware store or department store.
- The mall kiosk. Always the mall kiosk.
- Damaged previous customers' knives visible in their photos (uneven bevels, burned finishes, rounded tips).
...
| Service Type | 240mm Gyuto Price | What's Included |
|--------------|-------------------|-----------------|
| Quality whetstone (in-store) | $25-50 | Full sharpening, deburr, strop |
| Mail-in (Knife Aid, Korin, etc.) | $20-40 + shipping | Full service, before/after photos |
| Specialty / single-bevel sharpening | $60-150 | Yanagiba, deba, usuba require more skill |
| Chip repair / regrinding | $50-200 | Depending on damage severity |
| Full restoration | $150-500 | New geometry, polish, handle work |
| Bad-grinder service | $8-15 | Avoid. Costs nothing. Worth nothing. |
...
- Mail-in sharpening: $30 per knife x 4 sessions per year = $120
- Shipping: $15 each direction x 2 round trips = $60
...
- Year 1: DIY costs $305. Send-out costs $180. Send-out is cheaper.
- Year 2: DIY costs $325 cumulative. Send-out costs $360 cumulative. **DIY pulls ahead.**
- Year 3: DIY $345 vs send-out $540.
- Year 5: DIY $385 vs send-out $900.
- Year 10: DIY $485 vs send-out $1,800.
...
- Routine maintenance sharpening (the 80% case).
- Touch-ups every two to four weeks.
- Multiple knives.
- Stainless and basic carbon steel knives.
- Mid-range knives where the cost is recoverable if you make a mistake.

**Send out good for:**

- Chip repair or significant edge damage.
- Single-bevel knives (yanagiba, deba, usuba) — these have specialized geometry that takes years to learn properly.
- Damascus or kasumi-finished knives where the surface finish must be preserved.
- Knives over $500 where you do not yet trust your skills.
- Heirloom knives or sentimental pieces.
- When you do not have time to sharpen and need a working knife back fast.
...
- If you own one or two knives, cook a few times a week, and do not enjoy fiddling with tools, send out to a known good service. The math does not strongly favor DIY at low volume, and your knives will be in better hands than your untrained ones for the first year or two.

- If you own three or more Japanese knives, cook daily, and like learning new physical skills, DIY pays off financially and gives you faster turnaround. Start with a basic two-stone setup and practice on cheap knives before working on the expensive ones.

- Either way, never use a belt grinder, never use an electric pull-through, never use a kiosk in a mall, and always evaluate the service before you hand over the blade.
