---
title: "Yanagiba vs Sujihiki: The Slicing Knife Decision Guide"
description: "Yanagiba (single-bevel) vs sujihiki (double-bevel) — which slicing knife you actually need for sashimi, brisket, or both."
category: "comparison"
tags: [yanagiba, sujihiki, slicing, comparison, single-bevel]
publishedAt: "2026-04-29"
updatedAt: "2026-04-29"
relatedKnives: ["aritsugu-a-yanagiba-300", "masamoto-yanagiba-270", "misono-sujihiki-270", "sakai-takayuki-ginsan-yanagiba"]
articleType: "comparison"
---

I've owned a yanagiba for almost six years now, and a sujihiki for four. They sit next to each other in my knife drawer, and people always ask me the same question: "Aren't they basically the same knife?" The short answer is no. The longer answer is that they look similar — both long, slim, single-purpose slicers — but they're built for fundamentally different jobs, and using the wrong one will frustrate you.
...
- Cuts straight without steering
- Works for left or right hand
- Is sharpened on a whetstone the same way you'd sharpen a gyuto
- Handles cooked meat, fish, ham, smoked salmon, brisket, prime rib, turkey, pork loin
...
- A **yanagiba** has a chisel-like edge — one side angled, one side flat. When you push it through food, the angled side wedges material upward and the flat side stays clean. The slice releases in a single thin sheet.
- A **sujihiki** has a symmetrical V-shaped edge with bevels on both sides. It cuts straight down without preferring either side.
...
- Sashimi cuts (tuna, salmon, hamachi, kanpachi)
- Nigiri toppings sliced to exact thickness
- Whole fish breakdown after the deba does the rough work
- Any raw protein where slice cleanliness matters

**Yanagiba struggles with:**

- Cooked meat (the flat side has nothing to push fibers off cleanly)
- Anything with bones
- Citrus, vegetables, bread
- Left-handed users (you need a left-handed version, which costs more and has lower selection)

**Sujihiki excels at:**

- Brisket, prime rib, pork shoulder
- Hot smoked or cured salmon sides
- Roast turkey, ham, leg of lamb
- Sashimi, if you don't already have a yanagiba (it's competent here)
- Trimming silver skin from tenderloins

**Sujihiki struggles with:**

- Tall vegetables (the narrow blade isn't ideal for board-clearance work)
- Hard squash, frozen anything
- Bone-in cuts (use a different knife)
...
- **240mm** — apartment kitchens, small fish, beginners. Works but feels short.
- **270mm** — the sweet spot for home cooks who do sashimi seriously
- **300mm** — what most pros use. Better for whole side of salmon, large tuna loins
- **330mm** — pro/restaurant only

For sujihiki:

- **240mm** — fine for thinner roasts, smaller hams
- **270mm** — best all-around. Handles everything I throw at it
- **300mm** — go this long if you do whole brisket regularly
...
| | Yanagiba | Sujihiki |
|---|---|---|
| Bevel | Single (one-sided) | Double (V-edge) |
| Origin | Traditional Japanese (Kansai) | Japanese take on Western slicer |
| Primary use | Raw fish, sashimi | Cooked meat, BBQ, also fish |
| Edge angle | 10–15° single side | 12–15° per side (24–30° total) |
| Learning curve | Steep (months) | Gentle (days) |
| Sharpening | Specialist skill | Standard double-bevel |
| Lefty options | Limited, premium-priced | Any knife works either hand |
| Versatility | Low (one job) | Medium (many proteins) |
| Best length (home) | 270mm | 270mm |
| Entry price | ~$180 | ~$120 |
| Premium ceiling | $1,500+ | $600+ |
| Steel availability | Mostly carbon | Carbon and stainless both common |
...
**Entry ($180–$280):** [Sakai Takayuki Ginsan 270mm](/knives/sakai-takayuki-ginsan-yanagiba). Stainless single-bevel, much more forgiving than carbon for a first yanagiba. Sakai-made, traditional construction, won't rust if you blink.

**Mid ($350–$600):** [Aritsugu A-type 300mm](/knives/aritsugu-a-yanagiba-300) in white #2. Aritsugu is one of Tsukiji's legendary makers; their A-type is a workhorse with a long, beautiful blade and that classic Sakai feel.

**Premium ($800+):** [Masamoto Sohonten 270mm](/knives/masamoto-yanagiba-270) in white #2. Masamoto is the standard against which all yanagiba are measured. If you do this for a living, you eventually own one.

### Sujihiki

**Entry ($120–$180):** Tojiro DP 270mm. VG-10 stainless, plain Western handle, takes a great edge, won't rust. Ideal first sujihiki.

**Mid ($220–$350):** [Misono UX10 270mm](/knives/misono-sujihiki-270). Probably the best balance of build quality, edge retention, and price in the category. I've owned one for four years and it's still my daily slicer.
...
- The learning curve is real. Expect frustration.
- Carbon steel reacts with fish acids — you'll get patina fast, and if you neglect drying you'll get rust.
- Pro sharpening costs $40–$80 per session if you don't learn yourself.
- Lefty pricing is brutal. Often 30% premium for limited models.
- They take counter space (300mm is a foot of blade plus handle).

Sujihiki downsides:

- Less of a "specialty knife" feeling. Some buyers want the romance.
- Narrow blade isn't great for vegetables — don't think of it as a second gyuto.
- Easy to under-buy on length. 240mm feels short fast.
- Mid-tier sujihiki are crowded; lots of mediocre options around $150 that aren't worth it.

## FAQ

**Can I use a sujihiki for sashimi?**
Yes, and competently. It won't produce the same single-stroke perfection as a yanagiba, but a sharp sujihiki on tuna or salmon will give you slices you'd be proud to serve. I did this for two years before buying my yanagiba.

**Can I use a yanagiba on cooked meat?**
You can, but you shouldn't. The single-bevel pulls the blade in cooked fibers and the long flat back doesn't release the slice cleanly. You'll fight it. Worse, hot meat juice plus carbon steel is bad for the edge.

**Which is more useful for a home cook?**
Sujihiki, almost always. It covers more cooking situations. The yanagiba only earns its drawer space if you make sashimi at home regularly.

**Are there left-handed yanagiba?**
Yes, but they cost more and have lower selection. Most makers offer lefty versions but with multi-week lead times. Plan ahead. Sujihiki has no lefty/righty distinction.

**Do I need a deba too if I get a yanagiba?**
For whole-fish breakdown, yes — you need something to handle bones and the spine. But if you're buying pre-cut fish loins and only slicing, a yanagiba alone is fine.

**What's the difference between a yanagiba and a takobiki?**
